...
const CREDS = {
  ...
  endpoints: { accounts_service_url: CIS_URL },
};
...
describe('lib/cis-client', () => {
  ...
  describe('listSubaccounts', () => {
    ...
    it('uses creds.url when endpoints.accounts_service_url is missing', async () => {
      ...
      const result = await cis.listSubaccounts(credsNoEndpoints);
