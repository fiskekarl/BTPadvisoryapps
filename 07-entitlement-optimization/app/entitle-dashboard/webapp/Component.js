sap.ui.define([
  ...
  'use strict';
  return UIComponent.extend('com.btpconsulting.entitlement.Component', {
    metadata: { manifest: 'json' },
    init: function () {
      UIComponent.prototype.init.apply(this, arguments);
      const dev = new JSONModel(Device); dev.setDefaultBindingMode('OneWay');
      this.setModel(dev, 'device');
      this.setModel(new JSONModel({ summary: {}, entitlements: [], renewals: [], months: 12, busy: false }), 'entitle');
